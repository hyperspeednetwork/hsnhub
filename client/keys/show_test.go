...
import (
	...
	"github.com/hyperspeednetwork/hsnhub/crypto/keys"
	"github.com/hyperspeednetwork/hsnhub/tests"
...
func Test_multiSigKey_Properties(t *testing.T) {
	...
	assert.Equal(t, "hsn16wfryel63g7axeamw68630wglalcnk3lsud68u", tmp.GetAddress().String())
}
