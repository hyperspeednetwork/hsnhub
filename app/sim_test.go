...
import (
	...
	authsim "github.com/hyperspeednetwork/hsnhub/x/auth/simulation"
	"github.com/hyperspeednetwork/hsnhub/x/bank"
	distr "github.com/hyperspeednetwork/hsnhub/x/distribution"
	distrsim "github.com/hyperspeednetwork/hsnhub/x/distribution/simulation"
	"github.com/hyperspeednetwork/hsnhub/x/gov"
	govsim "github.com/hyperspeednetwork/hsnhub/x/gov/simulation"
	"github.com/hyperspeednetwork/hsnhub/x/mint"
	"github.com/hyperspeednetwork/hsnhub/x/params"
	paramsim "github.com/hyperspeednetwork/hsnhub/x/params/simulation"
	"github.com/hyperspeednetwork/hsnhub/x/simulation"
	"github.com/hyperspeednetwork/hsnhub/x/slashing"
	slashingsim "github.com/hyperspeednetwork/hsnhub/x/slashing/simulation"
	"github.com/hyperspeednetwork/hsnhub/x/staking"
	stakingsim "github.com/hyperspeednetwork/hsnhub/x/staking/simulation"
...
func getSimulateFromSeedInput(tb testing.TB, w io.Writer, app *HSNApp) (
...
func invariants(app *HSNApp) []sdk.Invariant {
	// TODO: fix PeriodicInvariants, it doesn't seem to call individual invariants for a period of 1
	// Ref: https://github.com/hyperspeednetwork/hsnhub/issues/4631
	if period == 1 {
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/hyperspeednetwork/hsnhub/HSNApp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
func BenchmarkFullAppSimulation(b *testing.B) {
	...
	app := NewHSNApp(logger, db, nil, true, 0)
...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewHSNApp(logger, db, nil, true, 0, fauxMerkleModeOpt)
	require.Equal(t, "HSNApp", app.Name())
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewHSNApp(log.NewNopLogger(), newDB, nil, true, 0, fauxMerkleModeOpt)
...
func TestAppSimulationAfterImport(t *testing.T) {
	...
	newApp := NewHSNApp(log.NewNopLogger(), newDB, nil, true, 0, fauxMerkleModeOpt)
	require.Equal(t, "HSNApp", newApp.Name())
