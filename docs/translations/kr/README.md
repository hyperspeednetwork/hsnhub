...
>*NOTE*: 코스모스 SDK 지원 문서의 완성도와 정확성을 높이기 위해 해당 문서는 꾸준히 업데이트 되고 있습니다. 혹시 오류나 제안사항이 있으시다면 [코스모스 포럼](https://forum.cosmos.network) 또는 [깃허브 이슈를](https://github.com/hyperspeednetwork/hsnhub/issues/new) 통해서 알려주시면 감사하겠습니다.

- [인트로](./intro/README.md): 코스모스 SDK에 대한 high-level 소개 자료
- [HSN](./hsnhub/README.md): HSN 애플리케이션(현재 코스모스 허브 명칭)에 대한 모든 문서들이 있습니다. HSN 테스트넷에 참여하는 방법에 대한 정보
...
`hsnhub` 애플리케이션(코스모스 허브의 애플리케이션)을 설치하고 퍼블릭 테스트넷에 참가하고 싶으시다면 여기를 클릭해주세요.
자체적인 `hsnhub` 테스트넷을 운영하고 싶으시다면 **[여기](./hsnhub/join-testnet.md)** 를 클릭해주세요.

자체적인 `hsnhub` 테스트넷 운영을 원하시는 경우 **[여기](./hsnhub/deploy-testnet.md)** 를 확인하세요 

## 기여하기

코스모스 도큐멘테이션 또는 코드 업데이트 규칙에 관련해서는 [이 파일](https://github.com/hyperspeednetwork/hsnhub/blob/master/docs/DOCS_README.md)을 참고해주세요.