...
import (
	...
	"github.com/hyperspeednetwork/hsnhub/x/auth/exported"
	"github.com/hyperspeednetwork/hsnhub/x/auth/keeper"
...
func TestEnsureSufficientMempoolFees(t *testing.T) {
	...
	ctx := input.Ctx.WithMinGasPrices(
		sdk.DecCoins{
			...
			sdk.NewDecCoinFromDec("stake", sdk.NewDecWithPrec(10000000000000, sdk.Precision)),   // 0.000001hsn
		},
	)
