...
```bash
go test -v --bench github.com/hyperspeednetwork/hsnhub/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/hyperspeednetwork/hsnhub/crypto/keys/mintkey
...
PASS
ok  	github.com/hyperspeednetwork/hsnhub/crypto/keys/mintkey	12.093s
```
