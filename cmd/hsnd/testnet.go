...
import (
	...
	"github.com/hyperspeednetwork/hsnhub/client/keys"
	"github.com/hyperspeednetwork/hsnhub/codec"
	"github.com/hyperspeednetwork/hsnhub/server"
	srvconfig "github.com/hyperspeednetwork/hsnhub/server/config"
	...
	genutiltypes "github.com/hyperspeednetwork/hsnhub/x/genutil/types"
...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a hsnd testnet",
...
Example:
	hsnd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "hsnd",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "hsncli",
	...
	cmd.Flags().String(
		...
		"Minimum gas prices to accept for transactions; All fees in a tx must meet this minimum (e.g. 0.01photino,0.001hsn)")
	return cmd
}
...
func InitTestnet(cmd *cobra.Command, config *tmconfig.Config, cdc *codec.Codec,
	...
	hsnConfig := srvconfig.DefaultConfig()
	hsnConfig.MinGasPrices = minGasPrices
	...
	for i := 0; i < numValidators; i++ {
		...
		// TODO: Rename config file to server.toml as it's not particular to HSN
		// (REF: https://github.com/hyperspeednetwork/hsnhub/issues/4125).
		hsnConfigFilePath := filepath.Join(nodeDir, "config/hsnd.toml")
		srvconfig.WriteConfigFile(hsnConfigFilePath, hsnConfig)
	}
