...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    mkdir -p /home/vagrant/go/src/github.com/hyperspeednetwork
    ln -s /vagrant /home/vagrant/go/src/github.com/hyperspeednetwork/hsnhub

    chown -R vagrant:vagrant /home/vagrant/go
    chown vagrant:vagrant /home/vagrant/.bash_profile

    su - vagrant -c 'source /home/vagrant/.bash_profile'
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/hyperspeednetwork/hsnhub && make tools'
  SHELL
end
