...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/hyperspeednetwork/hsnhub/types/errors.Wrap",
		"github.com/hyperspeednetwork/hsnhub/types/errors.Wrapf",
		"github.com/hyperspeednetwork/hsnhub/types/errors.WithType",
