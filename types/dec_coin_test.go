...
func TestParseDecCoins(t *testing.T) {
	testCases := []struct {
		...
		{"", nil, false},
		{"4hsn", nil, true},
		{"5.5atom,4hsn", nil, true},
		{"0.0hsn", nil, true},
		{"0.004HSN", nil, true},
		{
			"0.004hsn",
			DecCoins{NewDecCoinFromDec("hsn", NewDecWithPrec(4000000000000000, Precision))},
			false,
		},
		{
			"5.04atom,0.004hsn",
			DecCoins{
				...
				NewDecCoinFromDec("hsn", NewDecWithPrec(4000000000000000, Precision)),
			},
			false,
		},
	}
...
func TestDecCoinsString(t *testing.T) {
	testCases := []struct {
		...
		{DecCoins{}, ""},
		{
			...
			"5.040000000000000000atom,0.004000000000000000hsn",
		},
	}
...
func TestDecCoinsIntersect(t *testing.T) {
	testCases := []struct {
		...
		{"", "", ""},
		{"1.0hsn", "", ""},
		{"1.0hsn", "1.0hsn", "1.0hsn"},
		{"", "1.0hsn", ""},
		{"1.0hsn", "", ""},
		{"2.0hsn,1.0trope", "1.9hsn", "1.9hsn"},
		{"2.0hsn,1.0trope", "2.1hsn", "2.0hsn"},
		{"2.0hsn,1.0trope", "0.9trope", "0.9trope"},
		{"2.0hsn,1.0trope", "1.9hsn,0.9trope", "1.9hsn,0.9trope"},
		{"2.0hsn,1.0trope", "1.9hsn,0.9trope,20.0other", "1.9hsn,0.9trope"},
		{"2.0hsn,1.0trope", "1.0other", ""},
	}
